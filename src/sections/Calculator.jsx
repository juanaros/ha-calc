...
const Calculator = () => {
  ...
  return (
    <div className="m-5 flex justify-center">
      <div className="flex flex-col gap-4 w-full max-w-lg bg-white p-6 shadow-md rounded">
        ...
        />
        <button
          className="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm py-2.5 text-center mb-2"
          onClick={compute}
        >
          Calcular Momento Último
        </button>
        <div>
          {nominalMoment !== null && (
